...
def visualize(uuid: str = "ABCDEFGH-0123-4567-9910-ABCDEFGH1234"):
    datapath = "llm_load_test/static/" + uuid
    datafile = datapath + "/output.json"
    ...
    plt.text(
        max(total_tokens) * 0.5,
        avg_throughput + 100,
        f"Avg Throughput: {avg_throughput:.2f} tokens/sec",
        color="r",
    )

    plt.savefig(f"{datapath}/image.png")
