...
class Dataset:
    ...
    def __init__(
        ...
        self.dataset_list = [
            input
            for input in initialize_dataset(
                file,
        ...
        if len(self.dataset_list) < 4:
            logging.warning(
                "Total dataset is %s elements, check filters!", len(self.dataset_list)
            )
        self.index = 0
...
def initialize_dataset(
    ...
    with open(filename, "r", encoding="utf-8") as file:
        ...
        for line in lines:
            ...
            token_lengths_ok = filter_token_lengths(
                input_tokens,
                output_tokens,
                min_input_tokens,
                max_input_tokens,
